...
public class RenderTileDoorO extends TESRDynamXBlock<TileDoorO> {
    @Override
    public void render(TileDoorO te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        GL11.glPushMatrix();
