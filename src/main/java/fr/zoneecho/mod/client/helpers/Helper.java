...
import static fr.zoneecho.mod.client.helpers.HelperTexture.checkGLError;
import static fr.zoneecho.mod.client.helpers.HelperTexture.open;
...
public class Helper {
    ...
    public Helper(ResourceLocation location, @Nullable ResourceLocation fallback)
    {
        this(location, fallback, true);
    }

    public Helper(ResourceLocation location, @Nullable ResourceLocation fallback, boolean allowRP)
    {
        InputStream s = null;
        try
        {
