...
public class ErrorToast implements IToast {
    private final ErrorToast.Type type;
    private String title;
    private String subtitle;
    private long firstDrawTime;
    private boolean newDisplay;

    public ErrorToast(ErrorToast.Type typeIn, ITextComponent titleComponent, @Nullable ITextComponent subtitleComponent)
        {
            this.type = typeIn;
        ...
        public IToast.Visibility draw(GuiToast toastGui, long delta)
        {
            ...
            toastGui.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(Ref.MODID,"textures/toasts.png"));
        ...
        public ErrorToast.Type getType()
        {
            return this.type;
        }
