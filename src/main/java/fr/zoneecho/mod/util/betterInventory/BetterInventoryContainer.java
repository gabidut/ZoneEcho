package fr.zoneecho.mod.util.betterInventory;
...
public class BetterInventoryContainer extends Container {
    ...
    public BetterInventoryContainer(InventoryPlayer playerInventory, boolean localWorld, EntityPlayer playerIn)
    {
